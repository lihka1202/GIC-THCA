...
- [Class `Parser`](#class-parser)
  ...
  - [Methods](#parser-methods)
    ...
    - [`boolean isValidPositionAndDirection(int xCoord, int yCoord, char direction, int xGridBounds, int yGridBounds)`](#boolean-isvalidpositionanddirectionint-xcoord-int-ycoord-char-direction-int-xgridbounds-int-ygridbounds)
    - [`boolean isValidCommandLine(char[] commandLine)`](#boolean-isvalidcommandlinechar-commandline)
...
- [Unit Testing: `CarTest`](#unit-testing-cartest)
  - [Test Methods](#test-methods)
    ...
    - [`void carShouldMoveRightByOneUnit()`](#void-carshouldmoverightbyoneunit)
    - [`void carShouldNotCrossLeftMostBounds()`](#void-carshouldnotcrossleftmostbounds)
    - [`void carShouldNotCrossRightMostBounds()`](#void-carshouldnotcrossrightmostbounds)
    - [`void carShouldNotCrossUpperMostBounds()`](#void-carshouldnotcrossuppermostbounds)
    - [`void carShouldNotCrossLowerMostBounds()`](#void-carshouldnotcrosslowermostbounds)
    - [`void carShouldRotateRightByOne()`](#void-carshouldrotaterightbyone)
    - [`void carShouldRotateRightByTwo()`](#void-carshouldrotaterightbytwo)
    - [`void carShouldRotateRightByThree()`](#void-carshouldrotaterightbythree)
    - [`void carShouldRotateRightByFour()`](#void-carshouldrotaterightbyfour)
    - [`void carShouldRotateLeftByOne()`](#void-carshouldrotateleftbyone)
    - [`void carShouldRotateLeftByTwo()`](#void-carshouldrotateleftbytwo)
    - [`void carShouldRotateLeftByThree()`](#void-carshouldrotateleftbythree)
    - [`void carShouldRotateLeftByFour()`](#void-carshouldrotateleftbyfour)
    - [`void carReachesRightLocationAfterOneCommand()`](#void-carreachesrightlocationafteronecommand)
    - [`void carReachesRightLocationAfterManyCommands()`](#void-carreachesrightlocationaftermanycommands)
    - [`void carShouldNotMoveAfterCommandListIsComplete()`](#void-carshouldnotmoveaftercommandlistiscomplete)
- [Unit Testing: `ParserTest`](#unit-testing-parsertest)
  ...
  - [Test Methods](#parsertest-test-methods)
    ...
    - [`void shouldAvoidOneCarOutsideRightmostBoundFromMultiCarParse()`](#void-shouldavoidoncaroutsiderightmostboundfrommulticarparse)
    - [`void shouldAvoidOneCarOutsideUppermostBoundFromSingleCarParse()`](#void-shouldavoidoncaroutsideuppermostboundfromsinglecarparse)
    - [`void shouldAvoidOneCarOutsideUppermostBoundFromMultiCarParse()`](#void-shouldavoidoncaroutsideuppermostboundfrommulticarparse)
    - [`void shouldAvoidCarWithNegativeCarCoordinates()`](#void-shouldavoidcarwithnegativecarcoordinates)
    - [`void avoidParsingEmptyFile()`](#void-avoidparsingemptyfile)
    - [`void avoidParsingFileWithNegativeGridHeight()`](#void-avoidparsingfilewithnegativegridheight)
    - [`void avoidParsingFileWithNegativeGridWidth()`](#void-avoidparsingfilewithnegativegridwidth)
    - [`void shouldAvoidSingleCarWithWrongCommands()`](#void-shouldavoidsinglecarwithwrongcommands)
    - [`void shouldAvoidMultiCarWithWrongCommands()`](#void-shouldavoidmulticarwithwrongcommands)
    - [`void shouldAvoidMultiCarWithWrongDirection()`](#void-shouldavoidmulticarwithwrongdirection)
    - [`void shouldAvoidSingleCarWithWrongDirection()`](#void-shouldavoidsinglecarwithwrongdirection)
    - [`void shouldAvoidSingleCarWithWrongFileStructure()`](#void-shouldavoidsinglecarwithwrongfilestructure)
...
- [Unit Testing: `GridTest`](#unit-testing-gridtest)
  ...
  - [Test Methods](#gridtest-test-methods)
    ...
    - [`void twoCarsShouldNotCollide()`](#void-twocarsshouldnotcollide)
    - [`void fiveCarsShouldNotCollide()`](#void-fivecarsshouldnotcollide)
    - [`void fiveCarsShouldCollide()`](#void-fivecarsshouldcollide)
